...
import com.microservice.kafka.twitter_to_kafka_service.exception.TwitterToKafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    // JSON format accept by TwitterFactory to create STATUS
    ...
    // TIME format accept by TwitterFactory to create STATUS
    private static final String TWITTER_STATUS_DATE_FORMAT = "EEE MMM dd HH:mm:ss zzz yyyy";

    MockKafkaStreamRunner(TwitterKafkaStatusListener statusListener, TwitterToKafkaServiceConfigData configData){
